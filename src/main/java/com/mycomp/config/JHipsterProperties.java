...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "myGateWay@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "myGateWay API";

        private String description = "myGateWay API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "myGateWay";
